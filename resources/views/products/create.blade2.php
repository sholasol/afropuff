                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Upload product images. First image will be used as the product thumbnail if no featured image is set.</small>
                                    @error('images')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    @error('images.*')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('regular_price') is-invalid @enderror" 
                                                   id="regular_price" name="regular_price" step="0.01" 
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('weight') is-invalid @enderror" 
                                               id="weight" name="weight" step="0.01" value="{{ old('weight') }}">
                                        @error('weight')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('length') is-invalid @enderror" 
                                                   id="length" name="length" placeholder="Length" step="0.01" 
                                                   value="{{ old('length') }}">
                                            <input type="number" class="form-control @error('width') is-invalid @enderror" 
                                                   id="width" name="width" placeholder="Width" step="0.01" 
                                                   value="{{ old('width') }}">
                                            <input type="number" class="form-control @error('height') is-invalid @enderror" 
                                                   id="height" name="height" placeholder="Height" step="0.01" 
                                                   value="{{ old('height') }}">
                                        </div>
                                        @error('length')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="base_sku" value="">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="base_price" class="form-label">Base Price</label>
                                                <input type="number" class="form-control" id="base_price" step="0.01" value="">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="base_stock" class="form-label">Base Stock</label>
                                                <input type="number" class="form-control" id="base_stock" value="">
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-orange" data-bs-dismiss="modal">Continue</button>
                </div>
            </div>
        </div>
    </div>
