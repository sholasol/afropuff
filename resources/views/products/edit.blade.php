            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="../product-gallery.html" target="_blank" class="btn btn-outline-light me-2">
                                <i class="fas fa-eye me-2"></i>View Product
                            </a>
                            <button type="button" class="btn btn-orange" id="updateProductBtn">Update Product</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="productName" value="Dark Menthol" required>
                                </div>
                                <div class="mb-3">
                                    <label for="productSlug" class="form-label">Slug</label>
                                    <div class="input-group">
                                        <span class="input-group-text">vapexperience.com/product/</span>
                                        <input type="text" class="form-control" id="productSlug" value="dark-menthol">
                                    </div>
                                    <small class="text-muted">Leave blank to auto-generate from product name.</small>
                                </div>
                                <div class="mb-3">
                                    <label for="productSKU" class="form-label">SKU*</label>
                                    <input type="text" class="form-control" id="productSKU" value="VP-001" required>
                                </div>
                                <div class="mb-3">
                                    <label for="productDescription" class="form-label">Description*</label>
                                    <textarea class="form-control" id="productDescription" rows="6" required>Experience the refreshing coolness of our Dark Menthol e-cigarette. Crafted with premium ingredients for a smooth, satisfying vaping experience. Perfect for those who enjoy a crisp, minty flavor with every puff.

Our Dark Menthol flavor delivers an intense cooling sensation with a balanced sweetness that makes it perfect for all-day vaping. The premium quality ensures consistent flavor from the first puff to the last.</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="productShortDescription" class="form-label">Short Description</label>
                                    <textarea class="form-control" id="productShortDescription" rows="3">Premium menthol flavor with a dark twist. Intense cooling sensation with a perfect balance of sweetness.</textarea>
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row g-3" id="productImagesPreview">
                                            <div class="col-md-4 col-6">
                                                <div class="image-preview-box">
                                                    <img src="/placeholder.svg?height=200&width=200" class="img-fluid" alt="Product Image">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" id="productVideo" placeholder="YouTube or Vimeo URL">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="regularPrice" step="0.01" value="15.99" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="salePrice" step="0.01" value="12.99">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="scheduleSale" checked>
                                    <label class="form-check-label" for="scheduleSale">Schedule Sale</label>
                                </div>
                                <div class="row sale-schedule">
                                    <div class="col-md-6 mb-3">
                                        <label for="saleStart" class="form-label">Sale Start Date</label>
                                        <input type="date" class="form-control" id="saleStart" value="2024-01-01">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="saleEnd" class="form-label">Sale End Date</label>
                                        <input type="date" class="form-control" id="saleEnd" value="2024-03-31">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="stockQuantity" min="0" value="125" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="weight" step="0.01" value="3.5">
                                    </div>
                                    <div class="col-md-8 mb-3">
                                        <label class="form-label">Dimensions (inches)</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="length" placeholder="Length" step="0.01" value="4.5">
                                            <input type="number" class="form-control" id="width" placeholder="Width" step="0.01" value="2.0">
                                            <input type="number" class="form-control" id="height" placeholder="Height" step="0.01" value="1.5">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="hasVariants" checked>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-5">
                                                    <select class="form-select attribute-name">
                                                        <option value="nicotine" selected>Nicotine Strength</option>
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control attribute-values" placeholder="Values (comma separated)" value="3mg, 6mg, 12mg">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-md-5">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control attribute-values" placeholder="Values (comma separated)" value="30ml, 60ml">
                                                </div>
                                                <div class="col-md-1">
                                                ...
                                                <tbody id="variantsTableBody">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text">$</span>
                                                                <input type="number" class="form-control" value="12.99" step="0.01">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" value="45" min="0">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-1">
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text">$</span>
                                                                <input type="number" class="form-control" value="19.99" step="0.01">
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-2">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-light btn-sm variant-image-btn">
                                                                <i class="fas fa-image"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" value="25" min="0">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-3">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-light btn-sm variant-image-btn">
                                                                <i class="fas fa-image"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" value="20" min="0">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-4">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-light btn-sm variant-image-btn">
                                                                <i class="fas fa-image"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" value="15" min="0">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-5">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-light btn-sm variant-image-btn">
                                                                <i class="fas fa-image"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" value="10" min="0">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" value="VP-001-6">
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-outline-light btn-sm variant-image-btn">
                                                                <i class="fas fa-image"></i>
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="publishDate" value="2024-01-15T10:00">
                                </div>
                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-orange" id="updateBtn">Update</button>
                                    <button type="button"class="btn btn-outline-light" id="previewBtn">Preview Changes</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="menthol" id="categoryMenthol" checked>
                                        <label class="form-check-label" for="categoryMenthol">Menthol</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="fruity" id="categoryFruity">
                                        <label class="form-check-label" for="categoryFruity">Fruity</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="tropical" id="categoryTropical">
                                        <label class="form-check-label" for="categoryTropical">Tropical</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="dessert" id="categoryDessert">
                                        <label class="form-check-label" for="categoryDessert">Dessert</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="tobacco" id="categoryTobacco">
                                        <label class="form-check-label" for="categoryTobacco">Tobacco</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="productTags" placeholder="Enter tags separated by commas" value="menthol, cool, refreshing, mint">
                                    <small class="text-muted">Example: menthol, cool, refreshing</small>
                                </div>
                                <div class="popular-tags">
                                    <label class="form-label">Popular Tags:</label>
                                    <div class="tag-buttons">
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">menthol</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">fruity</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">sweet</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">tropical</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">dessert</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">cool</button>
                                        <button type="button" class="btn btn-sm btn-outline-light tag-btn mb-1">refreshing</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="featured-image-uploader">
                                    <div class="featured-image-preview">
                                        <img src="/placeholder.svg?height=300&width=300" class="img-fluid" alt="Featured Image">
                                        <div class="image-actions">
                                            <button type="button" class="btn btn-sm btn-light preview-image" title="Preview">
                                                <i class="fas fa-eye"></i>
                                            </button>
                        ...
                        <div class="dashboard-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="metaTitle" value="Dark Menthol - Premium Vape Flavor | VapeXperience">
                                </div>
                                <div class="mb-3">
                                    <label for="metaDescription" class="form-label">Meta Description</label>
                                    <textarea class="form-control" id="metaDescription" rows="3">Experience the refreshing coolness of our Dark Menthol e-cigarette. Premium quality, intense cooling sensation with a perfect balance of sweetness. Shop now at VapeXperience.</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="metaKeywords" class="form-label">Meta Keywords</label>
                                    <input type="text" class="form-control" id="metaKeywords" placeholder="Comma separated keywords" value="dark menthol, menthol vape, cool vape, mint flavor, premium e-liquid">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <a href="../product-gallery.html" class="btn btn-orange" target="_blank">View Product</a>
        </div>
    </div>
</div>
</div>
